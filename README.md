...
| `.test/Run-Demo.ps1` | UI demo launcher. Walks through what MuxCls prints while it works, with a readable per-file timer. Display only: no file is read, written or converted, and FFmpeg is never invoked. |
